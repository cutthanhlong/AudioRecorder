...
import com.example.audiorecorder.Adapter.LanguageAdapter;
...
import com.example.audiorecorder.databinding.ActivityLanguageBinding;
...
public class LanguageActivity extends BaseActivity<ActivityLanguageBinding> {
    ...
    public void setLangForApp() {
        startActivity(new Intent(LanguageActivity.this, MainScreenActivity.class));
        finishAffinity();
    }
